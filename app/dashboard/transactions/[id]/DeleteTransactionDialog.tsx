...
const DeleteTransactionDialog = ({xactionId, xactionDate}: {xactionId: number, xactionDate: Date}) => {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>This transaction will be deleted permanently and cannot be undone.</AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
